<!-- source: http://scpcbmr.42web.io/class_graphics-members.html -->
...
This is the complete list of members for [Graphics](class_graphics.md), including all inherited members.

|  |  |  |
| --- | --- | --- |
| [CreateImage](class_graphics.md)(Player player, string &in filename, float x, float y, float width, float height, bool align=false) | [Graphics](class_graphics.md) |  |
| [CreateOval](class_graphics.md)(Player player, float x, float y, float width, float height, bool align=false) | [Graphics](class_graphics.md) |  |
| [CreatePostEffect](class_graphics.md)(Player player, string &in filename, string &in defines="") | [Graphics](class_graphics.md) |  |
| [CreateProgressBar](class_graphics.md)(Player player, float time, float x, float y, float width, float height, bool align=false) | [Graphics](class_graphics.md) |  |
| [CreateProgressBar](class_graphics.md)(Player player, float time, float x, float y, float width, float height, bool align, string &in callback) | [Graphics](class_graphics.md) |  |
| [CreateProgressBar](class_graphics.md)(Player player, float time, float x, float y, float width, float height, bool align, ref &in callback) | [Graphics](class_graphics.md) |  |
| [CreateRect](class_graphics.md)(Player player, float x, float y, float width, float height, bool align=false) | [Graphics](class_graphics.md) |  |
| [CreateText](class_graphics.md)(Player player, int fontid, string &in text, float x, float y, bool align=false) | [Graphics](class_graphics.md) |  |
